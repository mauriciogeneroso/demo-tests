...
import com.example.demo.dto.GrafanaOutput;
...
public class NodeGraphController {
    ...
    @GetMapping("/api/fetchgraph")
    public GrafanaOutput fetchgraph(@RequestParam("query") String query) {
